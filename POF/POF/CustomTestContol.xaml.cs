...
namespace POF
{
    ...
    public sealed partial class CustomTestContol : UserControl
    {
        public CustomTestContol()
        {
            ...
            AlarmStandardSoundSelection = new AlarmStandardSoundSelection(ViewModelBase.Repository.StandardSoundFiles);
        ...
        {
            get { return (string)GetValue(SelectedSoundTitleProperty); }
            set { SetValue(SelectedSoundTitleProperty, value); }
        }

        public static readonly DependencyProperty SelectedSoundTitleProperty =
            DependencyProperty.Register("SelectedSoundTitle", typeof(string), typeof(CustomTestContol), new PropertyMetadata(String.Empty));
        ...
        public static readonly DependencyProperty IsPopUpOpenProperty =
            DependencyProperty.Register("IsPopUpOpen", typeof(bool), typeof(CustomTestContol), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty PopUpHeightProperty =
            DependencyProperty.Register("PopUpHeight", typeof(double), typeof(CustomTestContol), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty MyPropertyProperty =
            DependencyProperty.Register("MyProperty", typeof(double), typeof(CustomTestContol), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty PlayerProperty =
            DependencyProperty.Register("Player", typeof(MediaElement), typeof(CustomTestContol), new PropertyMetadata(0));

        public AlarmStandardSoundSelection AlarmStandardSoundSelection
        {
            get { return (AlarmStandardSoundSelection)GetValue(AlarmStandardSoundSelectionProperty); }
            set { SetValue(AlarmStandardSoundSelectionProperty, value); }
        }


        public static readonly DependencyProperty AlarmStandardSoundSelectionProperty =
            DependencyProperty.Register("AlarmStandardSoundSelection", typeof(AlarmStandardSoundSelection), typeof(CustomTestContol), new PropertyMetadata(0));

        public AlarmCustomSoundSelection AlarmCustomSoundSelection
        {
            get { return (AlarmCustomSoundSelection)GetValue(AlarmCustomSoundSelectionProperty); }
            set { SetValue(AlarmCustomSoundSelectionProperty, value); }
        }


        public static readonly DependencyProperty AlarmCustomSoundSelectionProperty =
            DependencyProperty.Register("AlarmCustomSoundSelection", typeof(AlarmCustomSoundSelection), typeof(CustomTestContol), new PropertyMetadata(0));
